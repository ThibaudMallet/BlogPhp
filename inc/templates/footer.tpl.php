      ...
      <aside class="col-lg-3">
        ...
        <div class="card">
          ...
          <ul class="list-group list-group-flush">
            <?php foreach ($dataCategoriesList as $currentId => $index) { ?>
              <li class="list-group-item"><a href="index.php?page=category&id=<?= $currentId ?>"><?= $index->categoryName ?></a></li>
            <?php } ?>
          </ul>
        </div>
        ...
        <div class="card">
          ...
          <ul class="list-group list-group-flush">
          <?php foreach ($dataAuthorsList as $currentId => $index) { ?>
              <li class="list-group-item"><a href="index.php?page=author&id=<?= $currentId ?>"><?= $index->authorName ?></a></li>
            <?php } ?>
          </ul>
        </div>
